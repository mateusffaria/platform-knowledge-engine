...
- Keep the existing CLI command working: pke ingest ./examples/profiles/canonical-professional-profile-v1.md
...
- pke ingest ./examples/profiles/canonical-professional-profile-v1.md still works
